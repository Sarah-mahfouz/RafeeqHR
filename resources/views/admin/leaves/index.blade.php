    ...
    <div class="col-12">
      ...
      <div id="employeesSearchWrapper">
        ...
        <button type="submit" id="employeesSearchButton">
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#777" viewBox="0 0 16 16">
            ...
            <form id="employeesDepartmentForm" class="employeesForm">
              <select name="department_id" id="employeesDepartmentFilter" onchange="this.form.submit()" style="border: 1px solid #c1a978; color: #7d6a43;">
        ...
        <div class="d-flex justify-content-between gap-2">
          <a href="{{ route('leaves.download.pdf') }}" class="btn btn-sm" style="background-color:rgb(64, 54, 35); color: white; width: 120px; height: 30px; font-size: 12px; display: flex; align-items: center; justify-content: center;">
      ...
      <div class="card my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <div style="background-color: #c1a978; color: white;" class="shadow border-radius-lg pt-4 pb-3">
                  ...
                  <td class="align-middle text-center">
                    <div class="d-flex justify-content-center gap-2">
                      <form method="POST" action="{{ route('admin.leaves.approve', $leave) }}">
                        @csrf
                        @method('PATCH')
                        <button type="submit" class="btn btn-sm" style="background-color: #c1a978; color: white; width: 70px; height: 28px; font-size: 11px; display: flex; align-items: center; justify-content: center;">Approve</button>
                      </form>

                      <button type="button" class="btn btn-sm" style="background-color: #7d6a43; color: white; width: 70px; height: 28px; font-size: 11px; display: flex; align-items: center; justify-content: center;" data-bs-toggle="modal" data-bs-target="#rejectModal{{ $leave->id }}">
                        Reject
                      </button>
                      ...
                      <div class="modal fade" id="rejectModal{{ $leave->id }}" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header" style="background-color: #c1a978; color: white;">
                            ...
                            <form method="POST" action="{{ route('admin.leaves.reject', $leave) }}">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary btn-sm" style="width: 70px; height: 28px; font-size: 11px; display: flex; align-items: center; justify-content: center;" data-bs-dismiss="modal">Cancel</button>
                                <button type="submit" class="btn btn-sm" style="background-color: #7d6a43; color: white; width: 70px; height: 28px; font-size: 11px; display: flex; align-items: center; justify-content: center;">Reject</button>
                              </div>
                            </form>
                          </div>
                        </div>
