    ...
    <div class="col-12">
      <div class="d-flex align-items-center justify-content-between mb-4">
          ...
          <div id="employeesFilterGroup">
            <form method="GET" action="{{ route('admin.leave-balances.index') }}" id="employeesSearchForm" class="employeesForm">
              <div id="employeesSearchWrapper">
                <input name="search" type="text" id="employeesSearchInput" placeholder="Search employees..." style="border: 1px solid #c1a978;">
                <button type="submit" id="employeesSearchButton" style="background-color: #c1a978; border: none;">
        ...
        <div class="d-flex justify-content-between gap-2">
          <a href="{{ route('leave.pdf') }}" class="btn btn-sm" style="background-color: #c1a978; color: white; width: 120px; height: 30px; font-size: 12px; display: flex; align-items: center; justify-content: center;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle text-center">
                    ...
                    <a class="btn btn-sm" href="{{ route('balance.update' ,['id' => $leave->id]) }}" style="background-color: #d4b773; color: white; width: 70px; height: 28px; font-size: 11px; display: flex; align-items: center; justify-content: center;">Update</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
