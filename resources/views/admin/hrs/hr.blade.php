...
<div class="container-fluid py-2">
  <div class="row">
    <div class="col-12">
      ...
      <div class="card my-4" style="background-color: #f5efe0;">
        ...
        <div class="card-body px-0 pb-2">
          <div class="px-3">
            <a class="btn" style="background: linear-gradient(45deg, #d4b773, #b39457); color: white;" href="{{ route('hr.create') }}" type="button">Add new HR</a>
          </div>
                ...
                <tr style="{{$loop->even ? 'background-color: #f5efe0;' : 'background-color: #ede4d0;'}}">
                  ...
                  <td class="align-middle text-center">
                    <div class="d-flex justify-content-center gap-2">
                      <a href="{{ route('hr.show', ['id' => $hr->id]) }}" class="btn btn-sm" style="background-color:rgb(239, 178, 57); color: white;">Show</a>
                      <a href="{{ route('hr.edit', ['id' => $hr->id]) }}" class="btn btn-sm" style="background-color: #d4b773; color: white;">Edit</a>
...
<style>
  ...
  .alert-success {
    background-color: #e6d6b3 !important;
