...
<style>
  ...
  /* تطبيق اللون الجديد */
  .bg-gradient-dark {
    background-image: linear-gradient(195deg, #d4b773 0%, #c0a566 100%) !important;
  }
  ...
  .btn-primary:hover {
    background-color: #c0a566 !important;
    border-color: #c0a566 !important;
  }
  ...
  .pagination-dark .page-link:hover {
    background-color: rgba(212, 183, 115, 0.2);
  }
    ...
    <div class="col-12">
      <div class="container-fluid">
        <div class=" p-2 row mb-3 align-items-center">
          <div class="col-12">
            <form method="GET" action="" id="authorsSearchForm" class="authorsForm border rounded p-3">
