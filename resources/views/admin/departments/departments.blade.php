...
<div class="container-fluid py-2">
    ...
    <div class="col-12">
      <div class="card my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <div style="background-color: #c1a978;" class="shadow border-radius-lg pt-4 pb-3">
            <h1 class="text-white text-capitalize ps-3">Departments</h1>
          </div>
        </div>
        <div class="card-body px-0 pb-2">
          <div class="px-3">
            <button type="button" class="btn" style="background-color: #7d6a43;; color: white;" data-bs-toggle="modal" data-bs-target="#departmentModal">Add new Department</button>
          </div>
                ...
                <tr>
                  ...
                  <td class="align-middle text-center">
                    <div class="d-flex justify-content-center gap-2">
                      <a href="{{ route('department.show', ['id' => $department->id]) }}" class="btn btn-sm" style="background-color:rgb(215, 170, 64); color: white;">Show</a>
                      <a href="#"
                        class="btn btn-sm" style="background-color:rgb(165, 125, 31); color: white;"
  ...
  <div class="modal fade" id="departmentModal" tabindex="-1" aria-labelledby="departmentModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="background-color: #7d6a43; color: white;">
        ...
        <div class="modal-body">
          <form method="POST" action="{{ route('create.department') }}">
            ...
            <div class="modal-footer px-0 pb-0">
              <button type="submit" class="btn btn-sm" style="background-color:rgb(204, 152, 32); color: white;">Add Department</button>
              <button type="button" class="btn btn-sm" style="background-color: #d4b773; color: white;" data-bs-dismiss="modal">Close</button>
            </div>
          </form>
        </div>
      </div>
