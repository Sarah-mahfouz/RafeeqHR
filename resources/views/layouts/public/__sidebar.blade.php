...
<body>
    ...
    <aside class="sidenav">
      ...
      <div class="navbar-collapse">
        <ul class="navbar-nav">
          ...
          <li class="nav-item" data-page="attendances">
          ...
          <li class="nav-item" data-page="leaves">
  ...
  <!-- Script to handle active menu state -->
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Find the menu item and make it active
      if (currentPage) {
        const menuItem = document.querySelector(`.nav-item[data-page="${currentPage}"]`);
        if (menuItem) {
